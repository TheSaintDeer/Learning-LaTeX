...
\begin{quotation}
    Čím \ více \ {\fontfamily{pbk}\selectfont druhů}, \ \emph{řezů}, \ {\tiny velikostí}, \ \textcolor{green}{barev} \ písma \ a \ \textsc{\textcolor{blue}{jiných \ efektů}} \ \underbar{použijeme}, \ \textcolor{red}{tím \ profesionálněji} \ bude \ {\fontfamily{pzc}\selectfont dokument} \ vypadat.
...
V češtině se používají uvozovky typu \uv{9966} místo ``anglických uvozove''.
